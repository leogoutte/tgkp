   subroutine generate_crystal_structure()
      ...
      write(*, '(a)') ' '
      write(*, '(a)') '<< Index-angle table >>'
      do i=1, 16
         write(*, '(a10, 10i8)') ' m:', m_index((i-1)*10+1:i*10)
         write(*, '(a10, 10f8.3)')'theta:', angle_t((i-1)*10+1:i*10)
         write(*, '(a10, 10i8)')'No. atoms:', number_of_atoms((i-1)*10+1:i*10)
      write(*, '(a8)') ' '
      enddo
      write(*, '(a)') '>>Index-angle table<<'
      write(*, '(a)') ' '
      ...
      write(*, '(a, i4)'), 'm= ', m
      write(*, '(a, f9.2)'), 'twisted angle', theta*180/pi
     ...
     !t1= m*a1 + (m+1)*a2;
      ...
      write(*, '(a, f8.3, a)')'length of lattice vector:', dsqrt(sum(t1**2)), ' Angstrom'
      ...
      write(*, '(a, i10)') 'number of atoms per cell', num_atom_total
   ...
   subroutine writeout_poscar(t1, t2, t3, num_atoms, atom_position_direct)
      use para, only : dp, outfileindex, cpuid
      implicit none
